...
export default function JoinUs() {
  ...
  Join <span style={{ color: '#ffffff', textShadow: '0 0 20px #9333ea, 0 0 40px #9333ea' }}>Syotria</span>
</h1>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-primary/10 border-2 border-primary/30 rounded-3xl p-8 text-center">
            ...
            <p className="text-foreground/70 leading-relaxed">
              ...
              <span className="font-bold text-primary">KES 500</span>. This helps us sustain and
